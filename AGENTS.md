...
| **Transcript Summaries** | [.agents/skills/capture-implementation/SKILL.md](.agents/skills/capture-implementation/SKILL.md) | Parsing conversation logs for turns and tool usage |
